...
class ShopGoodsAttributes extends Migration
{
    ...
    public function up()
    {
        Schema::create('shop_goods_attributes', function (Blueprint $table) {
            ...
            $table->tinyInteger('attrType')->nullable(false)->default(0)->comment('属性类型:0:输入框 1:多选项 2:下拉框');
            ...
            $table->tinyInteger('dataFlag')->nullable(false)->default(0)->comment('有效状态:1:有效 -1:无效');
            $table->engine = 'InnoDB';
            $table->timestamps();
        });
    }
