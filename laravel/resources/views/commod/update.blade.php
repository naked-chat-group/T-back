    ...
    <form id="addForm" class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="catName" value="{{ $user->attrName }}" lay-verify="required|ZHCheck" lay-reqtext="用户名是必填项，岂能为空？" lay-verify="catName" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <input type="hidden" id="attrId" value="{{ $user->attrId }}">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use(['upload','form'], function() {
            ...
            form.on('submit(submitBut)', function(data) {
                ...
                ajax('CommodManagementUpdates',{attrVal:catVal,attrName:catName,isShow:isShow,dataFlag:dataFlag,goodsCatId:goodsCatId,goodsCatPath:goodsCatPath,attrId:$('#attrId').val()},function(data){
                    if(data.code == 1)
                    {
